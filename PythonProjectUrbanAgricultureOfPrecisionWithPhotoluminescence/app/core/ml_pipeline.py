...
class VerticalFarmingPipeline:
    ...
    def load_trained_models(self, models_dir=None):
        ...
        try:
            ...
            # Definir rutas
            models_dir = project_root / "models" if models_dir is None else Path(models_dir)
            ...
            # Cargar feature metadata
            feature_metadata_path = data_dir / "feature_engineering_metadata.json"
